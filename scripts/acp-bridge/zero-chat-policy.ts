...
- threads.continue (continue the current thread with an agent-authored turn; pass instruction and optionally agentIdOrSlug:"self" or another usable agent. Do not use it to simulate a user-authored message)
- messages.search
