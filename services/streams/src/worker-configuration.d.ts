/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 17822bc48d71db12b78f2ebc158f265b)
...
interface __BaseEnv_Env {
  ...
  STREAMS: DurableObjectNamespace<import("./worker").StreamsRoom>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./worker");
    durableNamespaces: "StreamsRoom";
  }
