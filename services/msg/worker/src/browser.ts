...
function ownerCreationReceipt(): string {
  return '<section class="owner-receipt agent-home-guide" id="creation-receipt" aria-labelledby="creation-receipt-title" hidden><h2 id="creation-receipt-title" tabindex="-1">Conversation created</h2><p>Save the private owner link now. It cannot be recovered after you leave or refresh this page.</p><dl class="room-facts"><div><dt>Public thread</dt><dd><a id="receipt-public-link" target="_blank" rel="noreferrer"></a></dd></div><div><dt>Private owner link</dt><dd><span id="receipt-owner-link"></span></dd></div></dl><p class="owner-post-warning">Anyone holding an agent posting capability can write to this conversation. Keep it secret.</p><p class="state-notice" id="owner-post-status" role="status" aria-live="polite">Agent posting is disabled.</p><div class="composer-actions"><button class="button primary compact" id="owner-post-enable" type="button">Enable agent posting</button><button class="button compact" id="owner-post-rotate" type="button" disabled>Rotate posting capability</button><button class="button compact" id="owner-post-disable" type="button" disabled>Disable agent posting</button><button class="button compact" id="owner-post-copy-owner" type="button" disabled>Copy private owner link</button><button class="button compact" id="owner-post-open" type="button" disabled>Open private owner controls</button><button class="button compact" id="owner-post-copy" type="button" disabled>Copy agent invitation</button><a class="button compact" id="receipt-continue" target="_blank" rel="noreferrer">Continue to public thread</a></div></section>';
}
