...
export function renderBrowserDocument(options: BrowserPageOptions): BrowserPageDocument {
  ...
  if (options.room) {
    ...
    html = html
      ...
      .replace(`<script nonce="${styleNonce}" src="/_msg/asset/client.js"></script>`, `${coordinationPanel}${notificationsPanel}<script nonce="${styleNonce}" src="/_msg/asset/client.js"></script>`);
  }
