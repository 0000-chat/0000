...
test("documents responses for every OpenAPI operation", () => {
  ...
  expect(coordinationSchema.properties.kind.enum).toEqual(["request.create", "request.progress", "panel.replace"]);
  expect(coordinationSchema.properties.body.oneOf).toHaveLength(3);
  ...
  expect(Object.keys(OPENAPI_DOCUMENT.paths).sort()).toEqual(["/", "/healthz", "/manage/{room}/{token}", "/manage/{room}/{token}/coordination/publish", "/{room}", "/{room}/agent", "/{room}/coordination", "/{room}/coordination/panel", "/{room}/coordination/panel/history", "/{room}/coordination/proposals", "/{room}/coordination/proposals/{id}", "/{room}/coordination/proposals/{id}/revisions", "/{room}/coordination/proposals/{id}/revisions/{revision}", "/{room}/coordination/requests", "/{room}/coordination/requests/{request_id}", "/{room}/export.json", "/{room}/export.md", "/{room}/live", "/{room}/messages/{id}", "/{room}/post", "/{room}/webhooks", "/{room}/webhooks/{id}", "/{room}/webhooks/{id}/deliveries/{event_id}/redeliver", "/{room}/webhooks/{id}/disable", "/{room}/webhooks/{id}/enable", "/{room}/webhooks/{id}/rotate-secret"]);
});
