/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=/var/folders/1j/879mb6p12zz0svk0jf5w4l7h0000gn/T/0000-msg-wrangler-HO8370/wrangler.msg.jsonc /Users/komi/Documents/GitHub/0000-chat/0000/services/msg/worker/worker-configuration.d.ts` (hash: 69bf7ef784074fcc572d2098c742f518)
// Runtime types generated with workerd@1.20260916.1 2026-08-09 nodejs_compat
interface __BaseEnv_Env {
	MSG_DB: D1Database;
	MSG_RATE_LIMIT_CREATION: RateLimit;
	MSG_RATE_LIMIT_READS: RateLimit;
	...
	ChatGroup: DurableObjectNamespace<import("./src/worker-entry").ChatGroup>;
	ChatConnection: DurableObjectNamespace<import("./src/worker-entry").ChatConnection>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker-entry");
		durableNamespaces: "ConversationRoom" | "ChatGroup" | "ChatConnection";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MSG_CREATE_DISABLED" | "MSG_POST_DISABLED" | "MSG_PUBLIC_ORIGIN" | "MSG_DATA_ENCRYPTION_KEY_V1" | "MSG_OPERATOR_TOKEN" | "MSG_VAPID_PUBLIC_KEY" | "MSG_VAPID_PRIVATE_KEY" | "MSG_VAPID_SUBJECT">> {}
}
declare module "*.svg" {
	const value: string;
