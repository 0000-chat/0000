...
- Test that recommendations, silence, incomplete approvals, superseded proposal approvals, and owner summaries alone cannot publish accepted-decision records. Verify exact-revision evidence, visible unverified identity, correction attribution, disputes, and preserved history through public reads and export.
