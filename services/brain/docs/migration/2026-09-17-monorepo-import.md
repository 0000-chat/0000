...
- After the initial import base, destination `main` received the Gateway
  integration (`e798f3b`, followed by `fb85e8d`) and Cloud integration
  (`925cf1e`). The final reconciliation merges the fetched `origin/main` tip
  `925cf1ea856af1f38d6543c26b5354a69266e05a`, retaining these changes and the
  local Msg integration.
