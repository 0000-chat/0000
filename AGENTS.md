...
nor vendors Executor and contains no application implementation, runtime
dependency tree, database, API, deployment configuration, secret, or license.
Its package manifest declares development-only quality tooling.
