/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e074cf25e521d424f7c1eb81017b0f91)
// Runtime types generated with workerd@1.20260825.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	EVENT_ARCHIVE: R2Bucket;
	CONTROL_DB: D1Database;
	INGESTION_QUEUE: Queue;
	COMMUNICATOR_ENV: "staging" | "production" | "development";
	...
	COMMUNICATOR_ACCESS_ISSUER: "https://access.local.invalid/";
	COMMUNICATOR_ACCESS_AUDIENCE: "access-audience.local.invalid";
	COMMUNICATOR_ACCESS_JWKS_URL: "https://access.local.invalid/cdn-cgi/access/certs";
	COMMUNICATOR_INGRESS_ENABLED: "false";
	COMMUNICATOR_INGESTION_OIDC_ISSUER: "https://ingestion-auth.local.invalid/";
	COMMUNICATOR_INGESTION_OIDC_AUDIENCE: "communicator-ingestion";
	COMMUNICATOR_INGESTION_OIDC_JWKS_URL: "https://ingestion-auth.local.invalid/.well-known/jwks.json";
	COMMUNICATOR_OAUTH_ISSUER: "https://communicator-staging.local.invalid/" | "https://communicator-production.local.invalid/" | "https://communicator.local.invalid/";
	COMMUNICATOR_OAUTH_RESOURCE: "https://communicator-staging.local.invalid/mcp" | "https://communicator-production.local.invalid/mcp" | "https://communicator.local.invalid/mcp";
	COMMUNICATOR_OAUTH_ACCESS_TOKEN_TTL_SECONDS: "900";
	COMMUNICATOR_OAUTH_HUMAN_AUTHORIZE_URL: "https://auth.local.invalid/authorize";
	COMMUNICATOR_OAUTH_HUMAN_CLIENT_ID: "communicator-staging" | "communicator-production" | "communicator-local";
	COMMUNICATOR_OAUTH_HUMAN_REDIRECT_URI: "https://communicator-staging.local.invalid/oauth/callback" | "https://communicator-production.local.invalid/oauth/callback" | "https://communicator.local.invalid/oauth/callback";
	COMMUNICATOR_OAUTH_HUMAN_SCOPE: "openid profile";
	COMMUNICATOR_OAUTH_HUMAN_TOKEN_URL: "https://auth.local.invalid/token";
	COMMUNICATOR_OAUTH_HUMAN_ISSUER: "https://auth.local.invalid/";
	COMMUNICATOR_OAUTH_HUMAN_AUDIENCE: "communicator-api-staging" | "communicator-api-production" | "communicator-api";
	COMMUNICATOR_OAUTH_HUMAN_JWKS_URL: "https://auth.local.invalid/.well-known/jwks.json";
	CONNECTION_GATEWAY_URL: "https://matrix-gateway.internal.example.invalid";
	TENANT_PROJECTION: DurableObjectNamespace<import("./worker/index").TenantProjectionDO>;
	LINK_SESSIONS: DurableObjectNamespace<import("./worker/index").LinkSessionDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "TenantProjectionDO" | "LinkSessionDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COMMUNICATOR_ENV" | "COMMUNICATOR_DATA_MODE" | "COMMUNICATOR_OIDC_ISSUER" | "COMMUNICATOR_OIDC_AUDIENCE" | "COMMUNICATOR_OIDC_JWKS_URL" | "COMMUNICATOR_ACCESS_ISSUER" | "COMMUNICATOR_ACCESS_AUDIENCE" | "COMMUNICATOR_ACCESS_JWKS_URL" | "COMMUNICATOR_INGRESS_ENABLED" | "COMMUNICATOR_INGESTION_OIDC_ISSUER" | "COMMUNICATOR_INGESTION_OIDC_AUDIENCE" | "COMMUNICATOR_INGESTION_OIDC_JWKS_URL" | "COMMUNICATOR_OAUTH_ISSUER" | "COMMUNICATOR_OAUTH_RESOURCE" | "COMMUNICATOR_OAUTH_ACCESS_TOKEN_TTL_SECONDS" | "COMMUNICATOR_OAUTH_HUMAN_AUTHORIZE_URL" | "COMMUNICATOR_OAUTH_HUMAN_CLIENT_ID" | "COMMUNICATOR_OAUTH_HUMAN_REDIRECT_URI" | "COMMUNICATOR_OAUTH_HUMAN_SCOPE" | "COMMUNICATOR_OAUTH_HUMAN_TOKEN_URL" | "COMMUNICATOR_OAUTH_HUMAN_ISSUER" | "COMMUNICATOR_OAUTH_HUMAN_AUDIENCE" | "COMMUNICATOR_OAUTH_HUMAN_JWKS_URL" | "CONNECTION_GATEWAY_URL">> {}
}
